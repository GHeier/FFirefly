...
$(TARGET): $(OBJS) $(MAIN_OBJ)
	@$(CXX) $(OBJS) $(MAIN_OBJ) -o $(TARGET) $(CXXFLAGS) $(LIBS) 2>build.log || { echo "Build failed"; exit 1; }

# The target to build the final executable for the test program
test: $(TEST_TARGET)

$(TEST_TARGET): $(TEST_OBJS) $(OBJS)
	@$(CXX) $(TEST_OBJS) $(OBJS) -o $(TEST_TARGET) $(CXXFLAGS) $(LIBS) 2>build.log || { echo "Test build failed"; exit 1; }
...
# Rule to compile .cpp files into .o files in build/ for main program (excluding main.cpp)
