...
static bool test_jl_int_42() {
    int result = call_julia_func_int("config/tests/", "test_typed_interface", "TestTypedInterface", "return_int_42");
    if (result != 42) {
        return false;
    }
    return true;
...
static bool test_jl_int_negative() {
    int result = call_julia_func_int("config/tests/", "test_typed_interface", "TestTypedInterface", "return_int_negative");
    if (result != -100) {
        return false;
    }
    return true;
...
static bool test_jl_int_zero() {
    int result = call_julia_func_int("config/tests/", "test_typed_interface", "TestTypedInterface", "return_int_zero");
    if (result != 0) {
        return false;
    }
    return true;
...
static bool test_jl_compute_sum() {
    int result = call_julia_func_int("config/tests/", "test_typed_interface", "TestTypedInterface", "compute_sum");
    if (result != 60) {
        return false;
    }
    return true;
...
static bool test_jl_string_hello() {
    const char* result = call_julia_func_string("config/tests/", "test_typed_interface", "TestTypedInterface", "return_string_hello");
...
static bool test_jl_string_empty() {
    const char* result = call_julia_func_string("config/tests/", "test_typed_interface", "TestTypedInterface", "return_string_empty");
...
static bool test_jl_string_special() {
    const char* result = call_julia_func_string("config/tests/", "test_typed_interface", "TestTypedInterface", "return_string_special");
...
static bool test_jl_compute_message() {
    const char* result = call_julia_func_string("config/tests/", "test_typed_interface", "TestTypedInterface", "compute_message");
...
static bool test_jl_bool_true() {
    bool result = call_julia_func_bool("config/tests/", "test_typed_interface", "TestTypedInterface", "return_bool_true");
    if (result != true) {
        return false;
    }
    return true;
...
static bool test_jl_bool_false() {
    bool result = call_julia_func_bool("config/tests/", "test_typed_interface", "TestTypedInterface", "return_bool_false");
    if (result != false) {
        return false;
    }
    return true;
