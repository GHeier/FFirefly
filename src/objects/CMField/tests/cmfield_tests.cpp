...
complex<Vec> func_linear(Vec point) {
    return complex<Vec>(point(0) + point(1) + point(2) + point(3));
}
...
bool cmfield_tests() {
    ...
    bool all_tests[num_tests] = {
        interp_test_2d(),
        interp_test_2d_complex(),
        interp_test_3d(),
        interp_test_3d_complex(),
        interp_test_0d_with_w(),
        interp_test_1d_with_w(),
        interp_test_2d_with_w(),
        interp_test_3d_with_w(),
        interp_test_1d_with_n(),
        interp_test_1d_vector(),
        interp_test_2d_vector(),
        interp_test_3d_vector(),
        interp_test_1d(),
        interp_test_1d_complex(),
    };
