...
extern "C" void superconductor_wrapper() {
    ...
    else if (calculation == "eliashberg" && method == "lanczos") run_python_method2("lanczos");
    else if (calculation == "eliashberg" && method == "power_iteration") run_julia_method2("power_iteration");
    else {
