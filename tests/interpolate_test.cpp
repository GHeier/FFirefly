...
void test_interpolate_2D() {
    ...
    assert(interpolate_2D(0.5, 0.5, x_min, x_max, y_min, y_max, f) == 2.5); // Center point
...
void test_interpolate_3D() {
    ...
    assert(interpolate_3D(0.5, 0.5, 0.5, x_min, x_max, y_min, y_max, z_min, z_max, f) == 4.5); // Center point
...
void test_interpolate_4D() {
    ...
    assert(interpolate_4D(0.5, 0.5, 0.5, 0.5, x_min, x_max, y_min, y_max, z_min, z_max, w_min, w_max, f) == 8.5); // Center point
